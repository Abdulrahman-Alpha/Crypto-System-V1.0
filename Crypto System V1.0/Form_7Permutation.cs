...
{
    public partial class Form_7Permutation : Form
    {
        public Form_7Permutation()
        {
            InitializeComponent();
        }
    ...
    private void btn_Encrypt_Click_1(object sender, EventArgs e)
        {
            ...
            ShuffledNums[0] = int.Parse(txt_1Dec.Text);
            ShuffledNums[1] = int.Parse(txt_1Dec.Text);
            ShuffledNums[2] = int.Parse(txt_1Dec.Text);
            ShuffledNums[3] = int.Parse(txt_1Dec.Text);
            ShuffledNums[4] = int.Parse(txt_1Dec.Text);
            ShuffledNums[5] = int.Parse(txt_1Dec.Text);
            #endregion
